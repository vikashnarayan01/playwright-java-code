package com.javacode.playwright;
...
public class FileUploadHandle {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		page.setInputFiles("input#filesToUpload",
				new Path[] { Paths.get("applogin.json"), Paths.get("autostate.json"), Paths.get("example.png") });
		Thread.sleep(3000);
		page.setInputFiles("input#filesToUpload", new Path[0]);

		// run time file - upload:
		page.setInputFiles("input[name='upfile']",
				new FilePayload("naveen.text", "text/plain", "this is naveen here".getBytes(StandardCharsets.UTF_8)));
