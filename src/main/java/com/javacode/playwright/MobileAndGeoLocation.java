...
public class MobileAndGeoLocation {
	...
	public static void main(String[] args) throws InterruptedException {
		try (Playwright playwright = Playwright.create()) {
			...
			// .setUserAgent("Mozilla/5.0 (Linux; Android 8.0; Pixel 2
			// Build/OPD3.170816.012) AppleWebKit/537.36 (KHTML, like Gecko)
			// Chrome/75.0.3765.0 Mobile Safari/537.36")
			...
			// page.screenshot(new
			// Page.ScreenshotOptions().setPath(Paths.get("colosseum-pixel2.png")));
